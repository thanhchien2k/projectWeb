...
<body data-spy="scroll" data-target=".site-navbar-target" data-offset="300">
  ...
  <div class="site-wrap">
    ...
    <header class="site-navbar py-4 js-sticky-header site-navbar-target" role="banner">
      ...
      <div class="container-fluid">
        <div class="d-flex align-items-center">
          <div class="site-logo mr-auto w-25"><a href="index.php">TheFutureDev</a></div>
          ...
          <div class="mx-auto text-center">
            <nav class="site-navigation position-relative text-right" role="navigation">
              <ul class="site-menu main-menu js-clone-nav mx-auto d-none d-lg-block  m-0 p-0">
                ...
                <li><a href="#programs-section" class="nav-link">Sứ mệnh</a></li>
                <li><a href="#team-section" class="nav-link">Đội ngũ</a></li>
              </ul>
            </nav>
          </div>
          ...
          <div class="ml-auto w-25">
            <nav class="site-navigation position-relative text-right" role="navigation">
              <ul class="site-menu main-menu site-menu-dark js-clone-nav mr-auto d-none d-lg-block m-0 p-0">
                <li class="cta"><a href="#contact-section" class="nav-link"><span>Liên hệ với chúng tôi</span></a></li>
              </ul>
            </nav>
    ...
    <div class="intro-section" id="home-section">
      ...
      <div class="slide-1" style="background-image: url('images/bg.jpeg');" data-stellar-background-ratio="0.5">
        <div class="container">
                    ...
                    <form action="includes/login.inc.php" method="post" id="signin_form">
                      ...
                      if (isset($_GET['error'])) {
                        if ($_GET['error'] == "emptyfields") {
                          ...
                          if ($_GET['signup'] == "success")
                            echo '<div style="color:green;">Đăng nhập thành công !</div>';
                        }
                      } ?>
                      ...
                      <a href="mail_input.php">Quên mật khẩu</a>
                  ...
                  <div class="overlay-container">
                    <div class="overlay">
                      <div id="overlay-left" class="overlay-panel overlay-left">
                        ...
                        <p>Vui lòng đăng nhập bằng thông tin của bạn</p>
                        <button class="ghost" id="signIn">Đăng nhập</button>
                      </div>
                      <div class="overlay-panel overlay-right">
                        <h1>Xin chào!</h1>
                        <p>Điền thông tin cá nhân của bạn và bắt đầu học với chúng tôi</p>
    ...
    <div class="container">
      <div class="row mb-5 justify-content-center">
        <div class="col-lg-7 text-center" data-aos="fade-up" data-aos-delay="">
          ...
          <p>Mục tiêu của chúng tôi là làm cho việc học tập trở lên ĐƠN GIẢN, DỄ DÀNG và DỄ TIẾP CẬN CHO TẤT CẢ MỌI NGƯỜI, do đó chúng tôi đã tập hợp ở đây các KHÓA HỌC TỐT NHẤT trên thế giới.</p>
        </div>
      </div>
      <div class="row mb-5 align-items-center">
        ...
        <div class="col-lg-4 ml-auto" data-aos="fade-up" data-aos-delay="200">
          <h2 class="text-black mb-4">Giáo dục là nghệ thuật</h2>
          <p class="mb-4">Chúng tôi và bạn là những nghệ sĩ</p>

          <div class="d-flex align-items-center custom-icon-wrap mb-3">
            <span class="custom-icon-inner mr-3"><span class="icon icon-graduation-cap"></span></span>
            <div>
              <h3 class="m-0">123456 Học viên hàng năm</h3>
            </div>
          </div>
          ...
          <div class="d-flex align-items-center custom-icon-wrap">
            ...
            <div>
              <h3 class="m-0">50 Đại học hàng đầu thế giới</h3>
            </div>
          </div>
      ...
      <div class="row mb-5 align-items-center">
        ...
        <div class="col-lg-4 mr-auto order-2 order-lg-1" data-aos="fade-up" data-aos-delay="200">
          <h2 class="text-black mb-4">Giáo dục là hy vọng</h2>
          <p class="mb-4">Mục tiêu của chúng tôi là giúp các bạn thành công.</p>
      ...
      <div class="row mb-5 align-items-center">
        ...
        <div class="col-lg-4 ml-auto" data-aos="fade-up" data-aos-delay="200">
          <h2 class="text-black mb-4">Giáo dục là cuộc sống</h2>
          <p class="mb-4">Bắt đầu sự nghiệp học tập của bạn ngay thôi nào!</p>
      ...
      <div class="row">
        ...
        <div class="col-md-6 col-lg-4 mb-4" data-aos="fade-up" data-aos-delay="100">
          <div class="teacher text-center">
            ...
            <div class="py-2">
              <h3 class="text-black">Nguyễn Mạnh Chiến</h3>
        ...
        <div class="col-md-6 col-lg-4 mb-4" data-aos="fade-up" data-aos-delay="200">
          <div class="teacher text-center">
            ...
            <div class="py-2">
              <h3 class="text-black">Nguyễn Đức Chính</h3>
              <p class="position">Web developer</p>
            </div>
          </div>
        </div>
        ...
        <div class="col-md-6 col-lg-4 mb-4" data-aos="fade-up" data-aos-delay="300">
          <div class="teacher text-center">
            ...
            <div class="py-2">
              <h3 class="text-black">Ngô Văn Cường</h3>
              <p class="position">Web developer</p>
            </div>
          </div>
        </div>
  ...
  <div class="site-section bg-image overlay" style="background-image: url('images/bg.jpeg');">
    <div class="container">
      <div class="row justify-content-center align-items-center">
        <div class="col-md-8 text-center testimony">
          <img src="images/person_4.jpg" alt="Image" class="img-fluid w-25 mb-4 rounded-circle">
          <h3 class="mb-4">Mark Zuckerburg</h3>
          <blockquote>
            <p>&ldquo; Tôi đã từng vật lộn với việc học của mình nhưng tất cả đã thay đổi khi tôi biết đến TheFutureDev, và tôi hiện là kỹ sư phần mềm cấp cao với mức lương 9 con số mỗi năm. &rdquo;</p>
          </blockquote>
        </div>
      </div>
    </div>
        ...
        <div class="col-lg-4 ml-auto align-self-start" data-aos="fade-up" data-aos-delay="100">
          ...
          <div class="p-4 rounded bg-white why-choose-us-box">
            ...
            <div class="d-flex align-items-center custom-icon-wrap custom-icon-light mb-3">
              <div class="mr-3"><span class="custom-icon-inner"><span class="icon icon-graduation-cap"></span></span></div>
              <div>
                <h3 class="m-0">Các chuyên gia hàng đầu thế giới</h3>
              </div>
            </div>
            ...
            <div class="d-flex align-items-center custom-icon-wrap custom-icon-light mb-3">
              <div class="mr-3"><span class="custom-icon-inner"><span class="icon icon-university"></span></span></div>
              <div>
                <h3 class="m-0">Mở rộng kiến thức của bạn</h3>
              </div>
            </div>
            ...
            <div class="d-flex align-items-center custom-icon-wrap custom-icon-light mb-3">
              <div class="mr-3"><span class="custom-icon-inner"><span class="icon icon-graduation-cap"></span></span></div>
              <div>
                <h3 class="m-0">Các khóa học trực tuyến tốt nhất</h3>
              </div>
            </div>
            ...
            <div class="d-flex align-items-center custom-icon-wrap custom-icon-light">
              <div class="mr-3"><span class="custom-icon-inner"><span class="icon icon-university"></span></span></div>
              <div>
                <h3 class="m-0">Các giảng viên giỏi nhất</h3>
              </div>
            </div>
    ...
    <div class="container">
      ...
      <div class="row justify-content-center">
        <div class="col-md-7">
          ...
          <p class="mb-5">Chúng tôi rất hạnh phúc nếu được nhận các góp ý của bạn.</p>
          ...
          if (filter_has_var(INPUT_POST, 'submit')) {
            ...
            if (!empty($email) && !empty($name) && !empty($message) && !empty($subject)) {
              ...
              if (filter_var($email, FILTER_VALIDATE_EMAIL) === false) {
                ...
                // Passed
                $toEmail = 'support@thefuturedev.com';
          ...
          <form method="post" action="index.php#contact-section" data-aos="fade" id="contact_form">
            <div class="form-group row">
              <div class="col-md-12">
                ...
                <input type="text" name="name" id="contact_fullname" class="form-control" placeholder="Họ và tên" value="<?php echo isset($_POST['name']) ? $name : ''; ?>">
              </div>
            </div>
            ...
            <div class="form-group row">
              <div class="col-md-12">
                ...
                <input type="text" id="contact_subject" name="subject" class="form-control" placeholder="Chủ đề">
              </div>
            </div>
            ...
            <div class="form-group row">
              <div class="col-md-12">
                ...
                <textarea class="form-control" id="contact_message" name="message" cols="30" rows="10" placeholder="Điền tin nhắn của bạn tại đây"><?php echo isset($_POST['message']) ? $message : ''; ?></textarea>
              </div>
            </div>

            <div class="form-group row">
              <div class="col-md-6">
                <input type="submit" name="submit" class="btn btn-primary py-3 px-5 btn-block btn-pill" value="Gửi tin nhắn">
              </div>
            </div>
